module nf95_gunp_var_m
  ...
  interface nf95_gunp_var
     ...
     module procedure nf95_gunp_var_real_2d, nf95_gunp_var_real_3d, &
          nf95_gunp_var_dble
...
contains
  ...
  subroutine nf95_gunp_var_real_2d(ncid, varid, values, new_missing)
    ...
    if (ncerr_scale == nf95_noerr .or. ncerr_offset == nf95_noerr) then
       ...
       call nf95_get_var(ncid, varid, packed_values)
  ...
  subroutine nf95_gunp_var_dble(ncid, varid, values, new_missing)
